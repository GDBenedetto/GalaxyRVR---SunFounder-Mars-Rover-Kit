...
This project serves as an educational tool to advance the teaching of Systems Engineering (SE), incorporating methodologies from INCOSE, ISO/IEC 15288, and other relevant standards to provide hands-on learning experiences.
